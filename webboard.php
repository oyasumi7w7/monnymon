...
<style>
  ...
  <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="main.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Webboard</strong></div>
          
        </div>
      </div>
    </div>

<div class="jumbotron jumbotron-fluid" style="background-color: #B22222;">
  <div class="container" style="color:#FFF8DC;">
    <h1 style="font-size: 50px; border-bottom:double; margin-right: 50%;">Monnymon Webboard</h1>
    <p style="font-size: 25px; border-bottom:double ; border-right:double; margin-right: 75%;">มุมแลกเปลี่ยนข่าวสาร</p>
  </div>
</div>

        <?php 
        $topic = mysqli_query($con,"SELECT topic_id,topic_head,topic_pic,topic_time,topic_member FROM topics WHERE topic_type ='0' ORDER BY topic_time DESC;") or die("Sql Topics Error>>".mysqli_error($con));
    ...
    <div class="album py-5 bg-light">
      <div class="container">
          <a href="add_topic_form.php"><button type="button" class="btn btn-primary"<?php echo $dis; ?>>สร้างกระทู้</button></a>
          <br><br>
      <div class="row">
    
    
        <?php
        $result=mysqli_query($con,"SELECT topic_id,topic_head,topic_pic,topic_time,topic_member FROM topics WHERE topic_type ='0' ORDER BY topic_id DESC LIMIT $start_rows,$rows_page ")or die("Sql Error>>".mysqli_error($con));
        ...
        echo "<img src='images/topic/$topic_pic'  height='200px'>";
              ...
              echo"<div class='d-flex justify-content-between align-items-center'>";
                echo"<div class='btn-group'>";
                  echo"<a href='topic_view.php?id=$topic_id'><button type='button' class='btn btn-sm btn-outline-secondary'>View</button></a>";
