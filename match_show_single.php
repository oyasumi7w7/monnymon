      ...
      <div class='container'>
        <div class='row'>
          ...
          <?php
                  ...
                  ผลจับคู่รอบเก็บคะแนน</button></a>&nbsp; &nbsp;<br><br><br> ";
          ?>
                        ...
                        <ul class="bracket bracket-1" >
                            ...
                            for($i=8;$i<$loop;$i++){?>
                                ...
                                list($p2_r4,$p2_r4_name,$p2_r4_lastname)=mysqli_fetch_row($r4_2); 
                                        ...
                                        if(empty($p1_r4_name)){
                                          $wait_r4="<a style='color:#B22222' >รอผลการแข่ง</a>" ;
                                        }else{
                                          $wait_r4=$name_lastr4;
                                        }
  
                                        if(empty($p2_r4_name)){
                                          $wait_r4_2="<a style='color:#B22222' >รอผลการแข่ง</a>" ;
                                        }else{
                          ...
                          <ul class="bracket bracket-2">
                            ...
                            <?php for($i=4;$i<8;$i++){?>
                                ...
                                list($p2_r3,$p2_r3_name,$p2_r3_lastname)=mysqli_fetch_row($r3_2); 
                                        ...
                                        if(empty($p1_r3_name)){
                                          $wait_r3="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
                                          $wait_r3=$name_lastr3;
                                        }
  
                                        if(empty($p2_r3_name)){
                                          $wait_r3_2="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
                          ...
                          <ul class="bracket bracket-3">
                            <?php for($i=2;$i<4;$i++){?>
                                ...
                                list($p2_r2,$p2_r2_name,$p2_r2_lastname)=mysqli_fetch_row($r2_2); 
                                        ...
                                        if(empty($p1_r2_name)){
                                          $wait_r2="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
                                          $wait_r2=$name_lastr2;
                                        }
  
                                        if(empty($p2_r2_name)){
                                          $wait_r2_2="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
                          ...
                          list($p2_r1,$p2_r1_name,$p2_r1_lastname)=mysqli_fetch_row($r1_2); 
                                        ...
                                        if(empty($p1_r1_name)){
                                          $wait_r1="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
                                          $wait_r1=$name_lastr1;
                                        }
   
                                        if(empty($p2_r1_name)){
                                          $wait_r1_2="<a style='color:#228B22; border-bottom:2px solid red;' >รอผลการแข่ง</a>" ;
                                        }else{
