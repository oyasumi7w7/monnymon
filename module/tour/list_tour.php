...
if(empty($_SESSION['valid_user']) or $_SESSION['valid_type']!=1){
 ...
 if($do==1){
   echo '<script type="text/javascript">
         swal("", "เพิ่มรายการแข่งเสร็จเรียบร้อย", "success");
         </script>';
 }elseif($do==2){
    echo '<script type="text/javascript">
    swal("", "แก้ไขรายการแข่งเสร็จเรียบร้อย", "success");
    </script>';
 }elseif($do==3){
    echo '<script type="text/javascript">
...
?>
<meta charset="UTF-8">
<p align="center"><a style="font-size:50px; color:#A52A2A; ">รายการแข่งขัน</a></p><br><br>
...
<?php
	...
	echo "<form method='post' action='index.php?module=tour&action=multi_delete_tour'>"; //ส่งค่าจาก checkbox
?>	
	<p align="right" class="" >
 	<a href='index.php?module=tour&action=add_tour_form'><button type="button" class="btn btn-primary btn-ra " >
	<i class="fa fa-star"></i>&nbsp; เพิ่มรายการแข่ง</button></a>
	</p>
		<div class="table-responsive table--no-card m-b-30">
			<table class="table table-borderless table-striped table-earning">
				<thead>
			<?php
	echo"<tr><th style='text-align:center;'><a href='index.php?module=tour&action=list_tour&tx=$_GET[tx]'>$link</a></th>
	<th style='text-align:center;' width='5%'>รหัส</th>
	<th style='text-align:center;'>ชื่อรายการ</th>
	<th style='text-align:center;' width='5%'>สูงสุด</th>
...
?>	
	...
	echo "<tr><td style='text-align:center;' width='5%'><input type='checkbox' name='del_id[]' value='$t_no' $chk></td>"; 
...
<?php
	echo "<td>
	<a href='index.php?module=tour&action=edit_tour_form&tid=$t_no'><button type='button' class='btn btn-warning' ><i class='fa fa-pencil'></i>&nbsp;</button></a>
	<a href='index.php?module=tour&action=delete_tour_single&id=$t_no' onclick='return confirm(\" คุณแน่ใจหรือไม่ ว่าจะลบข้อมูลผู้ใช้นี้ \")'>
