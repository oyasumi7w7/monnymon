...
if(empty($_SESSION['valid_user']) or $_SESSION['valid_type']!=1){
 ...
 if($do==1){
   echo '<script type="text/javascript">
         swal("", "เพิ่มสินค้าใหม่เรียบร้อย", "success");
         </script>';
 }elseif($do==2){
    echo '<script type="text/javascript">
    ...
    echo '<script type="text/javascript">
    swal("", "เพิ่มประเภทเรียบร้อย", "success");
    </script>';
 }
?>
<meta charset="UTF-8">
...
<?php
	...
	<a href='index.php?module=item&action=edit_item_form&id=$pro_id'><button type='button' class='btn btn-warning' ><i class='fa fa-pencil'></i>&nbsp;</button></a></tr>";
	// echo "<td style='text-align:center;'>
