  ...
  ?>
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color: #B22222;">
      <div class="container" style="color:#FFF8DC;">
        ...
        <h2 style="font-size: 25px; border-bottom:double ; border-right:double; margin-right: 75%;">Topic:<?php echo"$topic_name";?></h2>
      </div>
    </div>
                                                          ...
                                                          echo"<div><strong>134</strong> posts</div>";
                                                              if(isset($_SESSION['valid_user'])){
                                                                  if($name_out==$_SESSION['valid_user']){
                                                                      $edit="
                                                                          <div>
                                                                              <a href='delete_comment.php?cid=$comment_id&&qid=$quest_id' onclick='return confirm(\" คุณแน่ใจหรือไม่ ว่าจะลบคอมเม้นนี้ \")'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
